-- 🔄 ADICIONAR: Ligações com nota inválida à fila de reprocessamento
-- Adiciona ligações com final_grade = -1 à fila para reprocessamento

-- 1. Verificar ligações com análise falhada que precisam ser reprocessadas
SELECT 'Ligações com análise falhada que precisam ser reprocessadas:' as info;
SELECT 
    c.id as call_id,
    c.status,
    c.duration,
