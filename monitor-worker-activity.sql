-- 📊 MONITORAR: Atividade do worker de análise
...
-- 2. Verificar ligações processadas nos últimos 30 minutos
SELECT 'Ligações processadas nos últimos 30 minutos:' as info;
SELECT 
    aq.call_id,
    aq.status,
    aq.created_at,
...
-- 3. Verificar ligações que falharam nos últimos 30 minutos
SELECT 'Ligações que falharam nos últimos 30 minutos:' as info;
SELECT 
    aq.call_id,
    aq.status,
    aq.created_at,
