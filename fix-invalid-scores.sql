-- 🔧 CORRIGIR: Ligações com nota inválida por falha de análise
-- Corrige ligações que receberam nota mesmo com falha na análise
...
-- 2. Corrigir ligações com nota inválida por falha de análise
UPDATE call_analysis 
SET 
    final_grade = -1,  -- Marcar como erro de análise
