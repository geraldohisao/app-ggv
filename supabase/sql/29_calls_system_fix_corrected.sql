-- 29_calls_system_fix_corrected.sql
-- Correção das funções RPC - ORDEM CORRIGIDA
-- Cria tabela pipedrive_deals PRIMEIRO, depois as funções

-- =========================================
-- ETAPA 1: CRIAR TABELA PIPEDRIVE_DEALS PRIMEIRO
-- =========================================
...
-- =========================================
-- ETAPA 2: FUNÇÃO CORRIGIDA PARA MAPEAMENTO SDR
-- =========================================
...
-- =========================================
-- ETAPA 3: FUNÇÃO CORRIGIDA PARA BUSCAR CALLS
-- =========================================
...
-- =========================================
-- ETAPA 4: FUNÇÃO CORRIGIDA PARA DETALHES DE CALL
-- =========================================
...
-- =========================================
-- ETAPA 5: FUNÇÃO CORRIGIDA PARA SDRS ÚNICOS
-- =========================================
...
-- Este script corrige o erro de "relation pipedrive_deals does not exist":
-- 1. ✅ Cria tabela pipedrive_deals PRIMEIRO
-- 2. ✅ Depois cria as funções que dependem dela
-- 3. ✅ Mapeamento SDR robusto com fallbacks
-- 4. ✅ Busca de empresa/pessoa com prioridades corretas
-- 5. ✅ Filtros funcionais (por email SDR)
-- 6. ✅ Identificação correta do SDR em todas as telas
