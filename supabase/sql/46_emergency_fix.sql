...
-- =========================================
-- VERIFICAR E RECRIAR FUNÇÕES BÁSICAS
-- =========================================

-- 1. Função get_dashboard_metrics (que o frontend chama)
...
-- 2. Função get_calls_with_filters (que o frontend chama)
...
-- 3. Função get_call_details (que o frontend chama)
...
-- 4. Função get_unique_sdrs (que o frontend chama)
...
-- Verificar se há dados na tabela calls
