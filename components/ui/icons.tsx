...
export const CalculatorIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25H9.008V14.251H9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 14.25H9.758V14.251H9.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 14.25H10.508V14.251H10.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 14.25H11.258V14.251H11.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25H12.008V14.251H12z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 14.25H12.758V14.251H12.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 14.25H13.508V14.251H13.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 14.25H14.258V14.251H14.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 14.25H15.008V14.251H15z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75H9.008V12.751H9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 12.75H9.758V12.751H9.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 12.75H10.508V12.751H10.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 12.75H11.258V12.751H11.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75H12.008V12.751H12z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 12.75H12.758V12.751H12.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 12.75H13.508V12.751H13.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 12.75H14.258V12.751H14.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12.75H15.008V12.751H15z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 11.25H9.008V11.251H9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 11.25H9.758V11.251H9.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 11.25H10.508V11.251H10.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25H11.258V11.251H11.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.25H12.008V11.251H12z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 11.25H12.758V11.251H12.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 11.25H13.508V11.251H13.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 11.25H14.258V11.251H14.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 11.25H15.008V11.251H15z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9.75H15V9.751H9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 21a3 3 0 01-3-3V9a3 3 0 013-3h15a3 3 0 013 3v9a3 3 0 01-3 3h-15z" />
    </svg>
);
...
export const DollarIcon = CurrencyDollarIcon;
...
export const RobotIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75v-3.75a1.5 1.5 0 0 0-1.5-1.5h-6a1.5 1.5 0 0 0-1.5 1.5v3.75m10.5 6v-3.75a1.5 1.5 0 0 0-1.5-1.5h-6a1.5 1.5 0 0 0-1.5 1.5v3.75m10.5 3.75h-10.5a1.5 1.5 0 0 1-1.5-1.5v-2.25a1.5 1.5 0 0 1 1.5-1.5h10.5a1.5 1.5 0 0 1 1.5 1.5v2.25a1.5 1.5 0 0 1-1.5 1.5Zm-10.5-3.75h10.5m-3.75-3.75v.008h.008v-.008h-.008Zm-3 0v.008h.008v-.008h-.008Z" />
    </svg>
);

export const Cog6ToothIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.438.995s.145.755.438.995l1.003.827c.48.398.668 1.05.26 1.431l-1.296 2.247a1.125 1.125 0 01-1.37.49l-1.217-.456c-.355-.133-.75-.072-1.075.124a6.57 6.57 0 01-.22.127c-.331.185-.581.496-.645.87l-.213 1.281c-.09.542-.56.94-1.11.94h-2.593c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.063-.374-.313-.686-.645-.87a6.52 6.52 0 01-.22-.127c-.324-.196-.72-.257-1.075-.124l-1.217.456a1.125 1.125 0 01-1.37-.49l-1.296-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.437-.995s-.145-.755-.437-.995l-1.004-.827a1.125 1.125 0 01-.26-1.431l1.296-2.247a1.125 1.125 0 011.37-.49l1.217.456c.355.133.75.072 1.075-.124.072-.044.146-.087.22-.127.332-.185.582-.496.645-.87l.213-1.281z" />
...
export const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C39.099 34.637 42 29.599 42 24c0-1.78-.192-3.498-.54-5.141z"/>
    </svg>
);

export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 0 0-3-3m3 3a3 3 0 0 1-3-3m3 3h3.75a3 3 0 0 0 3-3m-3.75 3a3 3 0 0 1 3-3m-3.75 3V18m-3-3a3 3 0 0 0-3 3m3-3V6.75A3 3 0 0 0 9 3.75a3 3 0 0 0-3 3v.001M12 18h3.75a3 3 0 0 0 3-3m-3.75 3V18m3-3a3 3 0 0 0 3 3m-3-3V6.75a3 3 0 0 0-3-3a3 3 0 0 0-3 3v.001" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a2.25 2.25 0 012.25-2.25H15a2.25 2.25 0 012.25 2.25v.001M15 6.75a2.25 2.25 0 00-2.25-2.25H9a2.25 2.25 0 00-2.25 2.25v.001" />
    </svg>
);
...
// Ícones específicos para áreas do diagnóstico
...
export const ChatBubbleBottomCenterTextIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.691 1.342 3.06 3 3.06h1.5l3 3 3-3h1.5c1.658 0 3-1.369 3-3.06V5.74c0-1.69-1.342-3.06-3-3.06H5.25c-1.658 0-3 1.37-3 3.06v6.77z" />
  </svg>
);
...
export const ClipboardDocumentListIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3-3.75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
  </svg>
);

export const PresentationChartLineIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l-1-3m1 3l-1-3m-16.5-3h9.75m.75-9L9 6.75l-1.5 1.5L15.75 12l-2.25 2.25" />
  </svg>
);
...
export const RefreshIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 7a8 8 0 0113.657-2.343L20 7M4 7h4M20 17a8 8 0 01-13.657 2.343L4 17m16 0h-4" />
  </svg>
);
...
export const KeyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM4.5 1.5 L1.5 4.5M21 4.5l-3-3m-12 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);

export const ClipboardDocumentIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.416 0v-3.042c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 0 1 1.927-.184" />
    </svg>
);
...
export const DocumentSignatureIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
// NOVOS ICONES ADICIONADOS PARA CONFIGURACOES
...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 5.223m0 0a9.935 9.935 0 0 0-4.682 2.72 9.094 9.094 0 0 0 3.741.479m0 0V19.5m0 0A5.995 5.995 0 0 1 12 12.75a5.995 5.995 0 0 1 5.058 5.223m0 0V21m0 0a14.85 14.85 0 0 0 2.837.47" />
    </svg>
);
...
export const BuildingOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5M9 12.75h1.5M9 18.75h1.5M13.5 6.75h1.5M13.5 12.75h1.5M13.5 18.75h1.5M6.75 6.75h.75M6.75 12.75h.75M6.75 18.75h.75M17.25 6.75h.75M17.25 12.75h.75M17.25 18.75h.75" />
    </svg>
);
