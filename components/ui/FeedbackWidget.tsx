...
const FeedbackWidget: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={onOpen}
        className={`fixed bottom-4 right-4 z-40 bg-slate-900 text-white shadow-md rounded-full px-3 py-2 flex items-center gap-2 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400`}
