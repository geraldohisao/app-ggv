-- 🔧 CORRIGIR: Campo score na função get_calls_with_filters
-- Execute este script no SQL Editor do Supabase

-- 1. Remover função atual
DROP FUNCTION IF EXISTS get_calls_with_filters CASCADE;

-- 2. Criar função corrigida com campo score
...
RETURNS TABLE (
    ...
    person TEXT,
    sdr_email TEXT,
    score NUMERIC, -- ✅ ADICIONADO: Campo score para o frontend
    total_count BIGINT
)
LANGUAGE SQL
SECURITY DEFINER
...
AS $$
    SELECT 
        ...
        -- ✅ CORREÇÃO: Campo score para o frontend
        CASE 
...
SELECT 'Função corrigida com campo score!' as status;
