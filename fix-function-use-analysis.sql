-- 🔧 CORRIGIR: Função get_calls_with_filters para usar call_analysis.final_grade
-- Execute este script no SQL Editor do Supabase

-- 1. Remover função atual
DROP FUNCTION IF EXISTS get_calls_with_filters CASCADE;

-- 2. Criar função corrigida usando call_analysis.final_grade (mesmo do detalhamento)
...
AS $$
    SELECT 
        ...
        -- ✅ CORREÇÃO: Usar call_analysis.final_grade (mesmo do detalhamento)
...
SELECT 'Função corrigida para usar call_analysis.final_grade!' as status;
...
SELECT 
    ...
    call_type,
    score,
    'call_analysis.final_grade' as fonte
