-- Script CORRIGIDO para criar o sistema de relatórios públicos de diagnóstico
...
-- ============================================================================
-- ETAPA 2: CONFIGURAR SEGURANÇA (RLS) - SIMPLIFICADO
-- ============================================================================

-- Habilitar Row Level Security
ALTER TABLE diagnostic_public_reports ENABLE ROW LEVEL SECURITY;

-- Política SIMPLIFICADA: Permitir leitura pública de relatórios não expirados
...
CREATE POLICY "Allow authenticated insert" ON diagnostic_public_reports
    FOR INSERT WITH CHECK (true);

-- Política: Permitir inserção para usuários anônimos (para funcionar sem login)
CREATE POLICY "Allow anonymous insert" ON diagnostic_public_reports
...
SELECT 'Função get_public_report criada com sucesso!' as status;
