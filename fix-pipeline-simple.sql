-- 🔧 CORREÇÃO SIMPLIFICADA: Extrair pipeline/etapa corretamente
-- Versão simplificada que funciona com a estrutura atual da tabela calls
...
-- 2. Atualizar função get_call_detail (versão simplificada)
