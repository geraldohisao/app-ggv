...
function cspProdOnly(): Plugin {
  return {
    ...
    transformIndexHtml(html) {
      ...
      const meta = `<meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self' https: data: blob:; style-src 'self' 'unsafe-inline' https:; font-src 'self' https: data:; connect-src 'self' https: wss: https://*.supabase.co https://*.supabase.in https://app.grupoggv.com https://api-test.ggvinteligencia.com.br; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'strict-dynamic'; base-uri 'self'; object-src 'none';">`;
