...
function cspProdOnly(): Plugin {
  return {
    ...
    transformIndexHtml(html) {
      ...
      const meta = `<meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' 'unsafe-eval'; img-src 'self' https: data: blob:; style-src 'self' 'unsafe-inline' https:; font-src 'self' https: data:; connect-src 'self' https: wss: https://*.supabase.co https://*.supabase.in https://app.grupoggv.com https://api-test.ggvinteligencia.com.br https://automation-test.ggvinteligencia.com.br https://generativelanguage.googleapis.com https://accounts.google.com https://oauth2.googleapis.com https://gmail.googleapis.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://apis.google.com; base-uri 'self'; object-src 'none';">`;
