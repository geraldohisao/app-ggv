-- 🔄 ADICIONAR: Ligações com nota zero à fila de reprocessamento
-- Adiciona ligações com nota zero à fila para reprocessamento automático

-- 1. Verificar ligações com nota zero que precisam ser reprocessadas
...
-- 2. Adicionar ligações com nota zero à fila de reprocessamento
...
-- 5. Verificar ligações que ainda têm nota zero
...
-- 6. Verificar se há ligações na fila que não foram processadas
