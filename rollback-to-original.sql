-- 🔄 ROLLBACK: Voltar para função original simples
-- Execute este script no SQL Editor do Supabase

-- 1. Remover função atual
DROP FUNCTION IF EXISTS get_calls_with_filters CASCADE;

-- 2. Criar função SIMPLES que funcionava antes
...
-- 4. Testar função revertida
SELECT 'Função revertida para versão simples!' as status;
