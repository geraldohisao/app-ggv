-- 🔍 VERIFICAR: Resto do debug das falhas
-- Script para verificar as outras partes do debug
...
-- 4. Verificar configurações adicionais do sistema
SELECT 'Configurações adicionais do sistema:' as info;
SELECT 
    key,
    value
FROM app_settings
