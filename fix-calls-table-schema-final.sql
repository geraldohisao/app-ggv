-- Script para corrigir a estrutura da tabela calls (VERSÃO FINAL CORRIGIDA)
...
-- =========================================
-- ETAPA 5: INSERIR DADOS DE EXEMPLO (CORRIGIDO)
-- =========================================
...
SELECT 
    ...
    jsonb_build_object(
        'company', 'Empresa ' || seq,
        'deal_id', 'deal_' || seq,
        'metadata', jsonb_build_object('company', 'Empresa ' || seq)
    ),
    CASE (seq % 2)
...
UNION ALL
SELECT '✅ Dados de exemplo inseridos (generate_series corrigido)'
UNION ALL
